...
use modor_graphics::{
    instance_2d, instance_group_2d, window_target, Color, Material, MaterialType, ZIndex2D,
    WINDOW_CAMERA_2D,
};
use modor_math::Vec2;
...
fn alive_cell_instance_group() -> impl BuiltEntity {
    instance_group_2d::<With<AliveCell>>(WINDOW_CAMERA_2D, MaterialType::Rectangle)

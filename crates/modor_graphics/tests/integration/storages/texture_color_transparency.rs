    ...
    App::new()
        ...
        .assert::<With<Capture>>(1, |e| {
            testing::assert_capture(
                e,
                "tests/expected/texture_color_transparency_with_opaque.png",
            )
        });
}
...
fn display_different_transparent_shapes() {
    App::new()
        ...
        .assert::<With<Capture>>(1, |e| {
            testing::assert_capture(
                e,
                "tests/expected/texture_color_transparency_with_multiple_shapes.png",
            )
        });
}
...
fn hide_shape_after_deletion() {
    App::new()
        ...
        .assert::<With<Capture>>(1, |e| {
            testing::assert_capture(
                e,
                "tests/expected/texture_color_transparency_cleaned_up.png",
            )
        });
}

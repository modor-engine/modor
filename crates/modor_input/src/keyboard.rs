...
/// # use modor_input::*;
/// #
/// fn access_keyboard(app: &mut App) {
...
/// # use modor_input::*;
/// #
/// fn modify_keyboard(app: &mut App) {
...
impl Keyboard {
    ...
    pub fn direction(&self, left: Key, right: Key, up: Key, down: Key) -> Vec2 {
        normalization::normalized_direction(
...
/// A keyboard key.
///
/// The keys are physical. For example, [`Key::KeyQ`] corresponds to <kbd>Q</kbd> with a QWERTY
/// layout and <kbd>A</kbd> with a AZERTY layout.
///
/// The enum conforms to the UI Events Specification's
